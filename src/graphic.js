...
function Graphic() {
  return (
    <div>
      <div className="text-center py-20 sm:px-14 sm:mt-7 px-6 sm:mx-10 sm:rounded-xl head3 text-white">
  ...
  return (
    <div className=" mt-16 w-4/5 mx-auto">
      <div className="mb-8 sm:flex">
        ...
        />
        <div className="text-center px-8 py-8 sm:pt-20 sm:px-5 rounded-b-lg bg-red-100 sm:rounded-r-xl sm:rounded-l-none">
      ...
      <div className="mb-8 sm:flex">
        ...
        <div className="text-center sm:pt-20 sm:px-5 px-8 py-8 rounded-b-lg bg-red-100 sm:rounded-r-xl sm:rounded-l-none">
          ...
          <p className="leading-6 mt-3 text-sm sm:text-base sm:text-base">
...
function Headthree() {
  return (
    <div className="text-white mt-10 sm:mx-10 px-5">
      ...
      <div className="app flex pl-12 mb-5 sm:h-52  items-center rounded-lg hover:bg-gradient-to-r hover:text-black from-orange-200">
