  ...
  return (
    <div className="bg-slate-700  relative p-5 text-center pb-8 mt-60 md:px-14 sm:px-7">
      ...
      <div className="sm:flex sm:justify-between md:px-15 xl:mx-28">
        ...
        <div className="text-white mt-5 leading-10 tracking-widest sm:mt-52 xl:mt-24 sm:flex sm:justify-evenly">
          <p className="sm:mr-5">
...
function Subhead() {
  return (
    <div className="flex justify-center items-center">
      <div className="head2 absolute mb-5 -top-44  h-auto  w-5/6 xl:flex xl:justify-between rounded-lg text-white py-14 px-6 sm:px-24">
        <div className="xl:text-left xl:w-2/5">
        ...
        <button className="mt-5 bg-white text-black p-3 rounded xl:h-12 xl:mt-8">
          GET IN TOUCH
        </button>
      </div>
    </div>
