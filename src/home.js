...
function Home() {
  return (
    <div className="lg:w-4/5 lg:mx-auto lg:mt-10 ">
      <Headtwo />
      <Headthree />
      <Headfour />
    </div>
...
function Headtwo() {
  return (
    <div className="text-center lg:px-32 lg:pt-14 md:pt-36 px-8 pt-24 head2 text-white sm:px-20 lg:rounded-2xl">
      ...
      <div className="flex justify-center items-center">
        <picture>
          ...
          <img src={img31} className="lg:rounded-t-3xl lg:mt-5" />
        </picture>
      </div>
    </div>
  );
...
function Headthree() {
  return (
    <div className="text-white mt-10 px-5 sm:px-16 md:px-18 lg:px-0">
      <div className="web sm:h-52 md:h-72 flex pl-12 mb-5 items-center text-left rounded-lg hover:bg-gradient-to-r hover:text-black from-orange-200">
      ...
      <div className="app flex pl-12 mb-5 sm:h-52  md:h-72 items-center rounded-lg hover:bg-gradient-to-r hover:text-black from-orange-200">
      ...
      <div className="design flex pl-12 mb-3  md:h-72 sm:h-52 items-center rounded-lg hover:bg-gradient-to-r hover:text-black from-orange-200">
...
function Headfour() {
  return (
    <div className="my-10 sm:mt-20 lg:px-0 lg:mx-0 ">
      <div className="text-center mx-auto w-4/5 items-center sm:flex lg:px-0 ">
        <div className="flex justify-center items-center ">
          <img src={img4} className="w-32 h-30 pass sm:w-96" />
        </div>
      ...
      <div className="text-center mt-10 mx-auto w-4/5 sm:flex">
        <div className="flex justify-center items-center">
          <img src={img5} className="w-32 h-30 pass sm:w-96" />
        </div>
        <div className="text-left ml-16">
      ...
      <div className="text-center mt-10 mx-auto w-4/5 sm:flex">
        <div className="flex justify-center items-center">
          <img src={img6} className="w-32 h-30 pass sm:w-96" />
        </div>
        <div className="text-left ml-16">
